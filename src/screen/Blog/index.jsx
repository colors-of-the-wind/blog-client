...
import {LoadBlog} from '../../utils/loadable';
...
export default class extends Component {
  render () {
    return (
      <ScrollContext.Provider value={{scrollTop: this.scrollTop.bind (this)}}>
        <div className="body">
          <div className="sidebar">
            <Header scrollTop={pos => this.scrollTop (pos)} />
          </div>
          <div className="main">
            <Scrollbars ref="mainScroll" autoHide>
          ...
          <div className="tool">
            <Scrollbars ref="toolScroll" autoHide>
